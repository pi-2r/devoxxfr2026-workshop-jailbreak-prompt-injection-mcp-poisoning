...
echo "==> [3/6] Cloning & installing Garak (into $HOME/garak)..."
GARAK_DIR="$HOME/garak"
if [ ! -d "$GARAK_DIR" ]; then
  git clone https://github.com/NVIDIA/garak.git --depth 1 "$GARAK_DIR"
fi
