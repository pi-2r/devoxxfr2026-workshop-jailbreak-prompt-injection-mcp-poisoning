...
![MCP add tool poisionning](./img/tool-poisonning.png)
![MCP Threat Model](./img/attacking-the-ecosystem-mcp-thread-model.png)
![Schema Francois](./img/schema-prompt-injection.jpeg)
...
Définition officiel d'anthropic sur les agents
